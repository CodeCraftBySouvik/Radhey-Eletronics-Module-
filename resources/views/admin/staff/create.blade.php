                    ...
                    <div class="row">                    
                        ...
                        <div class="col-sm-4">
                            <div class="form-group  mb-3">
                                ...
                                <input type="text" name="mobile" id="mobile" placeholder="Staff mobile" class="form-control" value="{{old('mobile')}}" onkeypress="validateNum(event)" maxlength="11">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group  mb-3">
                                ...
                                <input type="text" name="whatsapp_no" id="whatsapp_no" placeholder="Staff whatsapp no" class="form-control" value="{{old('whatsapp_no')}}" onkeypress="validateNum(event)" maxlength="11">
