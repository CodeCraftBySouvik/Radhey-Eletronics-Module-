                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" maxlength="11" name="mobile" id="mobile"  placeholder="User mobile" class="form-control" value="{{old('mobile')}}" onkeypress="validateNum(event)">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" maxlength="11" name="whatsapp_no" id="whatsapp_no" placeholder="User whatsapp no" class="form-control" value="{{old('whatsapp_no')}}" onkeypress="validateNum(event)">
