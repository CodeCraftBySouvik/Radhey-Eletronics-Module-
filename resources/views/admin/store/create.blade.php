                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" maxlength="11" name="contact" id="contact"  placeholder="Enter mobile number" class="form-control" value="{{old('contact')}}" onkeypress="validateNum(event)" autocomplete="off">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" maxlength="11" name="whatsapp" id="whatsapp" placeholder="Enter whatsapp number" class="form-control" value="{{old('whatsapp')}}" onkeypress="validateNum(event)" autocomplete="off">
